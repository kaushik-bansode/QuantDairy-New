...
def get_gl_entries(filters, accounting_dimensions):
	...
	gl_entries = frappe.db.sql(
		"""
		select
			name as gl_entry, posting_date, account, party_type, party, custom_party_name, 
...
def get_columns(filters):
	...
	columns = [
		...
		{"label": _("Voucher Type"), "fieldname": "voucher_type", "width": 160},
		{
			"label": _("Voucher No"),
		...
		{"label": _("Against Account"), "fieldname": "against", "width": 280},
		{"label": _("Party Type"), "fieldname": "party_type", "width": 100},
		{"label": _("Party"), "fieldname": "party", "width": 100},
		{"label": _("Party Name"), "fieldname": "custom_party_name", "width": 200},
	...
	if filters.get("include_dimensions"):
		...
		columns.append(
			{"label": _("Cost Center"), "options": "Cost Center", "fieldname": "cost_center", "width": 180}
		)

	columns.extend(
		[
			{"label": _("Against Voucher Type"), "fieldname": "against_voucher_type", "width": 150},
			{
